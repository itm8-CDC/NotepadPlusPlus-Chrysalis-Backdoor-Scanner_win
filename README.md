...
A notepad++ chrysalis backdoor convenience scanner for Microsoft Windows-based systems based on [Velociraptor](https://github.com/Velocidex/velociraptor)

## What's this?
This is a convenience scanner of the affected Notepad++ Chrysalis backdoor for Microsoft Windows-based systems.
Artifact development done by @mgreen27 as shared on [Artifacts exchange](https://docs.velociraptor.app/exchange/artifacts/pages/chrysalis/).


| Will this? |  :white_check_mark::x: |
| ---------- | ---------------------- |
| Remediate the vulnerability | :x:   |
| Find possible indicators of Chrysalis on a windows system? | :white_check_mark: |

## How to use
1. [Download](https://github.com/itm8-CDC/NotepadPlusPlus-Chrysalis-Backdoor-Scanner_win/archive/refs/heads/main.zip) or clone this repository
...
### Run on linux
The program is only developed for windows OS, thus the artifact is also only using windows compatible plugins and queries.
